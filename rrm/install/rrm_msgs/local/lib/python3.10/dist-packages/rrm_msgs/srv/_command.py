...
class Metaclass_Command_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('rrm_msgs')
        except ImportError:
            import logging
            import traceback
    ...
    def result_code(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'result_code' field must be an integer in [-2147483648, 2147483647]"
...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rrm_msgs.srv import _command
...
class Command(metaclass=Metaclass_Command):
    from rrm_msgs.srv._command import Command_Request as Request
    from rrm_msgs.srv._command import Command_Response as Response
