...
#ifndef RRM_MSGS__SRV__DETAIL__COMMAND__FUNCTIONS_H_
#define RRM_MSGS__SRV__DETAIL__COMMAND__FUNCTIONS_H_
...
#include "rrm_msgs/msg/rosidl_generator_c__visibility_control.h"
 ...
 * )) before or use
 * rrm_msgs__srv__Command_Request__create()
 ...
 * calls
 * rrm_msgs__srv__Command_Request__init().
...
/**
 * It calls
 * rrm_msgs__srv__Command_Request__fini()
 ...
 * rrm_msgs__srv__Command_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rrm_msgs__srv__Command_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * rrm_msgs__srv__Command_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_rrm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rrm_msgs__srv__Command_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rrm_msgs
...
/**
 * It calls
 * rrm_msgs__srv__Command_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rrm_msgs
...
/**
 * It allocates the memory for the array and calls
 * rrm_msgs__srv__Command_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rrm_msgs
...
/**
 * It calls
 * rrm_msgs__srv__Command_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RRM_MSGS__SRV__DETAIL__COMMAND__FUNCTIONS_H_
