...
bool rrm_msgs__srv__command__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rrm_msgs.srv._command.Command_Request", full_classname_dest, 37) == 0);
  }
  rrm_msgs__srv__Command_Request * ros_message = _ros_message;
  {  // positions
...
PyObject * rrm_msgs__srv__command__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rrm_msgs.srv._command");
...
ROSIDL_GENERATOR_C_EXPORT
bool rrm_msgs__srv__command__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rrm_msgs.srv._command.Command_Response", full_classname_dest, 38) == 0);
  }
  rrm_msgs__srv__Command_Response * ros_message = _ros_message;
  {  // result_code
    ...
    ros_message->result_code = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // message
...
PyObject * rrm_msgs__srv__command__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // result_code
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->result_code);
    {
