% Demo ukazka klasifikacie bodov v 3D priestore do 5 skupin
...
outnetsimbody = sim(net,bodynew')
triedy = vec2ind(outnetsimbody)
figure(h)
farby='bcgrm';
for i=1:5
    plot3(bodynew(i,1),bodynew(i,2),bodynew(i,3),[farby(triedy(i)) 's'],'MarkerSize',10,'LineWidth',2)   
end                